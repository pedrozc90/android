...
// DeviceFrequency (enum gererico) -> VendorFrequency (frequency especifica do fabricante) -> object SDK
// Object SDK  -> VendorFrequency (frequency especifica do fabricante) -> DeviceFrequency (enum gererico)
