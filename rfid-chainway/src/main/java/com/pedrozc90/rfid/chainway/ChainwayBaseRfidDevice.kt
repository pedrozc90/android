...
abstract class ChainwayBaseRfidDevice(
     ...
     */
    suspend fun configUHFInfo(epc: Boolean = true, tid: Boolean = true, rssi: Boolean = true, user: Boolean = false): Boolean
        = UHFConfig.configureInventory(reader = reader, epc = epc, tid = tid, rssi = rssi, user = user)
